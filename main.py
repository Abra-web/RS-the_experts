...
if __name__ == '__main__':
    data_set_sorted_by_songuri = pd.read_csv(
        "C:\\Users\\Tabea Heusel\\PycharmProjects\\RS-the_experts\\data\\csv\\songs.csv")
    df_songuri = pd.DataFrame(data_set_sorted_by_songuri)
    df_songuri = df_songuri.set_index('songs').T.to_dict('list')
    ...
    step1 = ss.song_searcher(input_song_uris, df_songuri)
